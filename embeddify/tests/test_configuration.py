...
def test_generic_slideshare():
    embedder = Embedder(width=200)
    assert embedder("http://de.slideshare.net/mrtopf/open-government-vortrag-aachen").startswith("""<iframe src="http://www.slideshare.net/slideshow/embed_code/13382702" """)
...
def test_plugin_specific_config():
    ...
    assert embedder("https://www.youtube.com/watch?v=2wii8hfNkzE").startswith("""<iframe width="200" height="113" src="http://www.youtube.com/embed/2wii8hfNkzE?feature=oembed""")
